...
const {Block, Transaction, Account} = require("../protocol/core/Litetokens_pb");
...
function buildAssetIssue(options) {
  ...
  contract.setXltNum(options.xltNum);
 ...
 * @param amount The amount of XLT to freeze
